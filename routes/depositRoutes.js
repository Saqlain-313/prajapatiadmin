...
const { createDeposit, getMyDeposits, updateDepositStatus, getAllDeposits, getDeposits, getTotalDepositStats } = require("../controllers/depositController");
...
router.get("/deposits/total-deposits", getTotalDepositStats);
