    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-[#0A0C0F] to-[#030405] p-4 md:p-6 lg:p-8">
                  ...
                  >
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-2">
                        <button
                          onClick={() => handleActionClick(d._id, "approved")}
                        ...
                        <button
                          onClick={() => handleActionClick(d._id, "rejected")}
      ...
      {!loading && pendingDeposits.length === 0 && (
        <div className={`${gradientCardClass} p-12 text-center`}>
          ...
          <p className="text-white/50 text-lg font-medium">No pending deposit requests found</p>
          <p className="text-white/30 text-sm mt-1">New pending deposits will appear here</p>
        </div>
      )}
