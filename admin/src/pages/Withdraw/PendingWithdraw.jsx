...
/* --------------------------------------------------------
   MAIN COMPONENT — Pending Withdrawals Only
-------------------------------------------------------- */
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-[#0A0C0F] to-[#030405] p-4 md:p-6 lg:p-8">
      ...
      {loading && (
        <div className="flex flex-col items-center justify-center py-16">
          ...
          <p className="text-white/50 text-sm">Loading pending withdrawal requests...</p>
        </div>
      )}
      ...
      {/* Withdrawals Table - Only Pending */}
      ...
      {!loading && pendingWithdrawals.length === 0 && (
        <div className={`${gradientCardClass} p-12 text-center`}>
          ...
          <p className="text-white/50 text-lg font-medium">No pending withdrawal requests found</p>
          <p className="text-white/30 text-sm mt-1">New pending withdrawal requests will appear here</p>
        </div>
      )}
